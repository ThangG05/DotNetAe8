...
namespace Motobike.Mathang
{
    public partial class Honda : Form
    {
        ...
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNetAe8\HangHoa\yahamaexciter.png";
            Thongtinxe(link);
        }

        private void picyamaha2_Click(object sender, EventArgs e)
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNetAe8\HangHoa\yamahafreego.png";
            Thongtinxe(link);
        }

        private void picyamaha3_Click(object sender, EventArgs e)
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNetAe8\HangHoa\yamahajanus.png";
            Thongtinxe(link);
        }

        private void picyamaha4_Click(object sender, EventArgs e)
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNetAe8\HangHoa\yamahanvx.png";
            Thongtinxe(link);
        }

        private void picyamaha5_Click(object sender, EventArgs e)
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNetAe8\HangHoa\yahamagrand.png";
            Thongtinxe(link);
        }

        private void picyamaha6_Click(object sender, EventArgs e)
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNetAe8\HangHoa\yamahasirius110cc.png";
            Thongtinxe(link);
        }
