...
namespace Motobike.Mathang
{
    public partial class Yamaha : Form
    {
        ...
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNetAe8\HangHoa\HONDAAIRBLADE.png";
            Thongtinxe(link);
        ...
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNetAe8\HangHoa\hondapcx.png";
            Thongtinxe(link);
        }

        private void pichonda3_Click(object sender, EventArgs e)
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNetAe8\HangHoa\HONDASHMODE.png";
            Thongtinxe(link);
        }

        private void pichonda4_Click(object sender, EventArgs e)
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNetAe8\HangHoa\HONDAVISION.jpg";
            Thongtinxe(link);
        }

        private void pichonda5_Click(object sender, EventArgs e)
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNetAe8\HangHoa\hondawinner.jpg";
            Thongtinxe(link);
        }

        private void pichonda6_Click(object sender, EventArgs e)
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNetAe8\HangHoa\HONDAWAVE.png";
            Thongtinxe(link);
        }
    }
}
