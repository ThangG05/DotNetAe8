...
namespace Motobike.Mathang
{
    public partial class Suzuki : Form
    {
        ...
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNetAe8\HangHoa\suzukiburgmanstreet.png";
            Thongtinxe(link);
        }

        private void picsuzuki2_Click(object sender, EventArgs e)
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNetAe8\HangHoa\suzukigsxr150.png";
            Thongtinxe(link);
        }

        private void pícuzuki3_Click(object sender, EventArgs e)
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNetAe8\HangHoa\suzukigsxs150.png";
            Thongtinxe(link);
        }

        private void picsuzuki4_Click(object sender, EventArgs e)
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNetAe8\HangHoa\suzukiraider.png";
            Thongtinxe(link);
        }

        private void picsuzuki5_Click(object sender, EventArgs e)
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNetAe8\HangHoa\suzukivstrom250cc.png";
            Thongtinxe(link);
        }

        private void picsuziki6_Click(object sender, EventArgs e)
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNetAe8\HangHoa\suzukiaddress.png";
            Thongtinxe(link);
        }
