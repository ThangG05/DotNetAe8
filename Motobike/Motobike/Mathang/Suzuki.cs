...
namespace Motobike.Mathang
{
    public partial class Suzuki : Form
    {
        ...
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNet\HangHoa\suzukiburgmanstreet.png";
            Thongtinxe(link);
        }

        private void picsuzuki2_Click(object sender, EventArgs e)
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNet\HangHoa\suzukigsxr150.png";
            Thongtinxe(link);
        }

        private void pícuzuki3_Click(object sender, EventArgs e)
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNet\HangHoa\suzukigsxs150.png";
            Thongtinxe(link);
        }

        private void picsuzuki4_Click(object sender, EventArgs e)
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNet\HangHoa\suzukiraider.png";
            Thongtinxe(link);
        }
    }
}
