...
namespace Motobike.Mathang
{
    public partial class Yamaha : Form
    {
        ...
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNet\HangHoa\HONDAAIRBLADE.png";
            Thongtinxe(link);
        ...
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNet\HangHoa\hondapcx.png";
            Thongtinxe(link);
        }

        private void pichonda3_Click(object sender, EventArgs e)
        {
            string link = @"D:\FINAL_PROJECT\.Net\DotNet\HangHoa\HONDASHMODE.png";
            Thongtinxe(link);
        }
